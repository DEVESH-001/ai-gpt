  ...
  return (
    <main
      className={cn(
        ...
        "flex items-center justify-center p-16  md:p-18 lg:p-14"
      )}
    >
      {/* Subtle dotted grid */}
      <div
      ...
      <PricingCard.Card>
        <PricingCard.Header>
          ...
          <PricingCard.Price>
            ...
            <PricingCard.Period>/ lifetime *</PricingCard.Period>
          ...
          <Button
            className={cn(
              ...
              "bg-linear-to-b from-orange-500 to-orange-600 shadow-[0_10px_25px_rgba(255,115,0,0.3)] cursor-pointer"
            )}
          >
            Get Started
          </Button>
